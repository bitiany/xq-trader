...
async def sync_to_registry() -> int:
    ...
    for plugin in _REGISTRY.values():
        ...
        _append_row(FacFactorRegistry(
            ...
            compute_mode=defn.compute_mode,
            density=defn.density,
            preprocess_policy=defn.preprocess_policy,
    ...
    count = await FacFactorRegistry.bulk_create_or_update(
        ...
        update_fields=[
            "display_name", "category", "group_id", "direction", "usage",
            ...
            "composite_factor_ids", "compute_mode", "density", "preprocess_policy",
            "composite_method", "description",
        ],
        batch_size=100,
    )
