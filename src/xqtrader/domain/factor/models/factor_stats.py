...
class FacFactorStats(AuditedBase):
    ...
    ic_mean_5d: Mapped[float | None] = mapped_column(Float, nullable=True, comment="5日前向收益IC均值")
    ic_mean_10d: Mapped[float | None] = mapped_column(Float, nullable=True, comment="10日前向收益IC均值")
    ic_mean_20d: Mapped[float | None] = mapped_column(Float, nullable=True, comment="20日前向收益IC均值")
